...
using System;
namespace JusticeLeague.Client.Account.Login {
    /// <summary>
    /// Builds and executes requests for operations under \account\login
    /// </summary>
    public class LoginRequestBuilder : BaseRequestBuilder {
        ...
        public LoginRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/account/login{?useCookies*,useSessionCookies*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LoginRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LoginRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/account/login{?useCookies*,useSessionCookies*}", rawUrl) {
        }
